    ...
    "credit": [
      {
        ...
        "detail": "BI 基准利率 26.07 5.75 → 2026.08 5.75；USD/IDR（JISDOR） 26.07 18128 → 2026.08 17703；采集异常/待配置：BPS WebAPI",
        "link": "credit-tracker/dashboard/credit-dashboard.html#sec1",
        "action": "核对期间、单位和官方原文；确认后才把候选值写入正式宏观序列。",
        "source": "macro-monitor"
      },
      {
        "title": "P2P竞对批量抓取 2026-08-25: 9/9 家成功",
        ...
        "source": "p2p-scraper",
        "id": "p2p-scraper:2026-08-25:0"
      }
    ],
    "stability": []
  },
  "updated": "2026-08-25 02:01"
};
