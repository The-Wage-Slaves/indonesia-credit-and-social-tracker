...
function render(){
  ...
  document.getElementById('app').innerHTML = `
    ...
    <div class="section">
      ...
      <p class="note">读图: 制度支柱(40)仍低于其1998位置(45)，外部第三方(两家评级展望负面、CPI 34、WJP四届连降)与事件计数(4个关键机构被政治化)互为印证。强制机构(37)已贴近1998(35)——实弹冲突2起+对峙，是全框架离历史崩溃位最近的支柱。货币(41)本周随卢比回落至18k下方、外资回流小幅回升，仍高于1998(25)且通胀锚完好。社会(55)离临界有距离——线上反对率小幅退烧(37%)但街头抗议扩散至泗水，补贴红线仍守。</p>
    </div>`;
