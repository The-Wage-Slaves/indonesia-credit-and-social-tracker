const V4_COMPARISON = {
  ...
  "measurement": {
    ...
    "sourceDirectnessFactors": {
      "primary": 1,
      "secondary": 0.85,
      "internal_review": 0.65,
      "crawler": 0.7
    },
    "publishCoverageFloor": 0.75
  },
  "ratings": {
    "medianScore": 59.5,
    ...
    "agencies": [
      ...
      },
      {
        ...
        "effectiveIndex": 8.5,
        "score": 59.5,
        "source": "https://www.bi.go.id/en/iru/economic-market-data/Pages/-Fitch-Affirms-the-Republic-of-Indonesia%E2%80%99s-Rating-at-BBB-and-Revises-Outlook-to-Negative.aspx"
      },
      {
        "agency": "Moody's",
        "rating": "Baa2",
        ...
        "effectiveIndex": 8.5,
        "score": 59.5,
        "source": "https://www.bi.go.id/en/iru/economic-market-data/Pages/Moody%27s-Affirmed-the-Republic-of-Indonesia%27s-Sovereign-Credit-Rating-at-Baa2%2C-Outlook-Revised-to-Negative.aspx"
      }
    ]
  },
  "pillars": [
      ...
      "drivers": [
        {
          ...
          "scoreInputs": [
            {
              "metric": "deficit_debt_r_minus_g_composite",
              "value": "2.85%; 40.75%; approximately 0",
              "unit": "mixed fiscal ratios",
              "transform": "migration_anchor_pending_36_month_percentile_history",
              "score": 55,
              "weight": 1
            }
          ],
          ...
          "basis": "连续财政变量的迁移代理；后续补齐收入/GDP、利息/收入和 r-g 历史序列。",
          "missingReason": null
        },
        {
          ...
          "scoreInputs": [
            {
              "metric": "reserve_import_cover",
              "value": 5.5,
              "unit": "months",
              "transform": "migration_anchor_pending_IMF_ARA_and_short_term_debt_series",
              "score": 60,
              "weight": 1
            }
          ],
        ...
        },
        {
          ...
          "scoreInputs": [
            {
              "metric": "foreign_SBN_BI_absorption_external_debt_composite",
              "value": "13.9%; +40% YoY; 29.9%",
              "unit": "mixed funding ratios",
              "transform": "migration_anchor_pending_component_percentiles",
              "score": 40,
              "weight": 1
            }
          ],
          "evidenceClass": "statistical",
          "availability": "medium",
          "evidenceQuality": 0.637,
          "freshnessQuality": 0.983,
          "sourceDirectness": 0.65,
          "observationIds": [
            "funding_mismatch_2026_05"
          ],
          "basis": "保留外债与外国持债结构，不重复使用短期市场流量。",
          "missingReason": null
        },
        {
          ...
          "availability": "low",
          "evidenceQuality": 0.323,
          "freshnessQuality": 0.914,
          "sourceDirectness": 0.65,
          "observationIds": [
        ...
        },
        {
          ...
          "observationIds": [
            ...
            "rating_moodys_2026_02_05"
          ],
          "basis": "评级等级先决定主分，展望仅作±0.5 notch调整；BBB正面仍低于A-负面。",
          "missingReason": null
        }
      ]
    },
      ...
      "drivers": [
        {
          ...
          "scoreInputs": [
            {
              "metric": "inflation_real_policy_rate_composite",
              "value": "3.44%; +2.4%",
              "unit": "percent",
              "transform": "migration_anchor_pending_36_month_target_deviation_history",
              "score": 60,
              "weight": 1
            }
          ],
          ...
          "scoreInputs": [
            {
              ...
              "value": "JISDOR 17,703 on 2026-08-31; about -5.5 percent year to date against the 16,777 official 2025 close",
              "unit": "percent",
          ...
          "scoreInputs": [
            {
              ...
              "value": "JCI USD return approximately -35%; flow incomplete",
    ...
    },
    {
      ...
      "missingWeight": 0.0,
      "lowConfidenceWeight": 0.1,
      "measurementConfidence": 0.635,
      "availabilityQuality": 0.715,
      "freshnessQuality": 0.959,
      "sourceDirectness": 0.79,
      ...
      "drivers": [
        {
          ...
          "availability": "medium",
          "evidenceQuality": 0.666,
          "freshnessQuality": 0.914,
          "sourceDirectness": 0.85,
          "observationIds": [
            "dsi_policy_shift_2026_07"
          ],
          "basis": "DSI政策时点/范围变化只归属政策可预见性一次。",
          "missingReason": null
        },
        {
          ...
          "scoreInputs": [
            {
              "metric": "external_governance_proxy",
              "value": 42.9,
              "unit": "percentile composite",
              "transform": "migration_anchor_pending_peer_cross_section",
              "score": 42,
              "weight": 1
            }
          ],
          ...
          "basis": "国际治理指标作过渡代理，避免与法治和制衡的综合分重复。",
          "missingReason": null
        },
        {
          ...
          "evidenceClass": "event_count",
          "availability": "medium",
          "evidenceQuality": 0.606,
          "freshnessQuality": 0.914,
          "sourceDirectness": 0.65,
          "observationIds": [
            "legal_case_registry_2026_07"
          ],
          "basis": "唯一案件清单；与强制机构冲突的武装事件记录分离。",
          "missingReason": null
        },
        {
          ...
          "evidenceClass": "event_count",
          "availability": "medium",
          "evidenceQuality": 0.744,
          "freshnessQuality": 0.986,
          "sourceDirectness": 1.0,
          "observationIds": [
    ...
    },
    {
      ...
      "measurementConfidence": 0.581,
      "availabilityQuality": 0.672,
      "freshnessQuality": 0.991,
      ...
      "drivers": [
        {
          ...
          "scoreInputs": [
            {
              "metric": "layoffs_and_employment_stress",
              "value": "43000; PMI employment fastest fall since 2021",
              "unit": "people and survey signal",
              "transform": "migration_anchor_pending_wage_food_transport_history",
              "score": 40,
              "weight": 1
            }
          ],
          ...
          "basis": "劳动力和实际生计变量，不使用PMI headline。",
          "missingReason": null
        },
        {
      ...
      "drivers": [
        {
          ...
          "basis": "每个武装/对峙事件只有一个主记录；法律程序另属制度支柱。",
          "missingReason": null
        },
        {
          "id": "role_boundary",
        ...
        },
        {
          ...
          "basis": "迁移占位；未来只测拒令、异常调动、公开分歧和多重指挥。",
          "missingReason": null
        },
        {
          ...
          "basis": "只纳入军警安全领导层倒戈、拒绝执行和公开阵营分化。",
          "missingReason": null
        }
      ]
    }
  ],
  "evidenceFile": "evidence/2026-09-01.json",
  "caveats": [
