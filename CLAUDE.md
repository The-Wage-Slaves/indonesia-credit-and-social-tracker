...
- `credit-tracker/sentiment-monitor/credit_sentiment.py` is the pending-review
  news/social digital-credit fear monitor; source confidence is separate from risk.
...
- Never commit secrets. `street_heat_config.yaml` and
  `credit_sentiment_config.yaml` are intentionally ignored.
